        ...
        button.addEventListener('click', function(e) {
            ...
            document.querySelectorAll('.analyze-resume-btn').forEach(btn => {
                if (btn !== this) {
                    ...
                    btn.disabled = false;
                    btn.innerHTML = '<i class="bi bi-clipboard-data"></i>';
                }
            });

            if (isVisible) {
                resultRow.style.display = 'none'; // Hide if already visible
                this.innerHTML = '<i class="bi bi-clipboard-data"></i>'; // Reset button text/icon
                this.disabled = false;
            } else {
                    ...
                    .finally(() => {
                        ...
                        resultContent.innerHTML = ` 
                            <div class="d-flex align-items-center text-secondary p-3">
                                ...
                                <i>Đang phân tích CV bằng công nghệ AI tiên tiến để cung cấp kết quả chi tiết và đầy đủ. Quá trình này có thể mất vài phút, vui lòng đợi...</i>
                            </div>
                        `;
                        this.disabled = true;
                        ...
                        .then(data => {
                            if ((data.success && data.analysis_html) || 
                                    ...
                                    resultContent.innerHTML = `
                                        <div class="d-flex flex-column align-items-center text-secondary p-3">
                                            ...
                                            <div class="alert alert-info w-100">
                                                <p><i class="bi bi-info-circle me-2"></i><strong>Thông báo:</strong> ${data.message || 'Đang phân tích CV bằng công nghệ AI tiên tiến để cung cấp kết quả chi tiết và đầy đủ. Quá trình này có thể mất vài phút, vui lòng đợi...'}</p>
                                                <div class="progress mt-2" style="height: 5px;">
                                                    <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style="width: 100%"></div>
                                                </div>
                                                <p class="small mt-2 mb-0 text-muted">Chúng tôi đang sử dụng công nghệ AI tiên tiến để phân tích CV của bạn một cách chi tiết và toàn diện. Kết quả sẽ hiển thị tự động sau khi hoàn tất.</p>
                                            </div>
                                        </div>
                                    `;
                                ...
                                if (data.status === 'completed' && data.analysis_markdown) {
                                    ...
                                    resultContent.innerHTML = `
                                        <div class="card mb-0">
                                            <div class="card-header cv-analysis-header d-flex justify-content-between align-items-center">
                                                <h5 class="card-title mb-0"><i class="bi bi-file-earmark-text me-2"></i>Phân tích chuyên sâu CV của bạn</h5>
                                                <div>
                                                    <button class="btn btn-sm btn-outline-secondary print-analysis">
                                                        <i class="bi bi-printer me-1"></i>In
                                                    </button>
                                                    <button class="btn btn-sm btn-outline-secondary ms-2 close-analysis">
                                            ...
                                            <div class="card-body p-0">
                                                <nav>
                                                    <div class="nav nav-tabs cv-analysis-tabs" id="nav-tab" role="tablist">
                                    ...
                                    strengthsTab.addEventListener('shown.bs.tab', function() {
                                        ...
                                        if (strengthsSection) {
                                            strengthsContent.innerHTML = '<div class="cv-analysis-markdown">' + renderMarkdown(strengthsSection) + '</div>';
                                        } else {
                                    ...
                                    improvementsTab.addEventListener('shown.bs.tab', function() {
                                        ...
                                        if (improvementsSections) {
                                            improvementsContent.innerHTML = '<div class="cv-analysis-markdown">' + renderMarkdown(improvementsSections) + '</div>';
                                        } else {
                        ...
                        .finally(() => {
                            ...
                            this.disabled = false;
                            this.innerHTML = '<i class="bi bi-clipboard-data"></i>';
                        });
                    });
            }
        });
            ...
            if (attempt % 3 === 0 && attempt > 0) {
                resultContent.innerHTML = `
                    <div class="d-flex flex-column align-items-center text-secondary p-3">
                        ...
                        <div class="alert alert-info w-100">
                            <p><i class="bi bi-info-circle me-2"></i><strong>Thông báo:</strong> Hệ thống AI đang phân tích CV của bạn.</p>
